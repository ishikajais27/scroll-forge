      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <motion.div
            ...
            className="md:col-span-2"
          >
            <h3 className="text-3xl font-bold mb-4 text-white">Brentley</h3>
            <p className="text-white/40 max-w-md leading-relaxed">
              Premier luxury real estate brokerage specializing in exceptional
              properties worldwide. Transform your property vision into reality
              with Brentley.
            </p>
          </motion.div>
          ...
          >
            ...
            <ul className="space-y-3">
              {['Instagram', 'LinkedIn', 'Facebook', 'YouTube'].map((item) => (
                <li key={item}>
                  <a
                    href="#"
                    className="text-white/50 hover:text-white transition-colors"
        ...
        >
          <p className="text-white/30 text-sm">
            © {new Date().getFullYear()} Brentley Real Estate. All rights
            reserved.
          </p>
          <p className="text-white/30 text-sm">
            Crafted for exceptional living.
          </p>
        </motion.div>
      </div>
    </motion.footer>
