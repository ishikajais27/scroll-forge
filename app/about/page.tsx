    ...
    <div className="relative text-white min-h-screen">
        ...
        <div className="container mx-auto px-4 md:px-8 text-center">
          <ScrollAnimatedSection>
            ...
            <motion.p
              ...
              className="text-sm md:text-base text-white/60 max-w-md mx-auto leading-relaxed"
            >
              Premium service for discerning clients in luxury real estate.
            </motion.p>
          </ScrollAnimatedSection>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <ScrollAnimatedSection direction="left">
              ...
              >
                Founded in 2010, Brentley Real Estate emerged from a passion for
                connecting clients with exceptional properties. What began as a
                boutique agency evolved into a premier real estate firm serving
      ...
      <section className="py-12 md:py-16">
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              { title: 'Integrity', desc: 'Honest transactions.' },
              { title: 'Excellence', desc: 'Premium service quality.' },
              { title: 'Discretion', desc: 'Confidential client care.' },
              { title: 'Expertise', desc: 'Market knowledge.' },
            ].map((value, index) => (
              <ScrollAnimatedSection key={index} delay={index * 0.1}>
                <Card3D depth={15}>
                  <motion.div
